...
class ServicioCamara: ViewModel(){
    ...
    suspend fun conectar_con_camara (contexto_aplicacion: Context, dueño_del_ciclo_de_vida: LifecycleOwner){
        val proceso_camara_proveedor = ProcessCameraProvider.awaitInstance(contexto_aplicacion)
